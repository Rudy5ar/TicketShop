...
INSERT INTO `ticket_shop`.`manifestation` (`name`, `type`, `num_of_seats`, `date`, `price_regular`, `status`, `location_id`,
                             `user_id_seller`)
VALUES ('Concert', 'Music', 1000, '2024-06-15 19:00:00', 50, 1, NULL, NULL),
       ('Theater Play', 'Drama', 500, '2024-07-20 18:30:00', 30, 1, NULL, NULL),
       ('Sports Event', 'Sports', 2000, '2024-08-10 15:00:00', 60, 1, NULL, NULL),
       ('Conference', 'Business', 300, '2024-09-05 09:00:00', 20, 1, NULL, NULL),
       ('Opera Night', 'Music', 800, '2024-06-25 20:00:00', 70, 1, NULL, NULL),
       ('Comedy Show', 'Comedy', 300, '2024-07-30 19:30:00', 25, 1, NULL, NULL),
       ('Basketball Game', 'Sports', 1500, '2024-08-20 16:00:00', 45, 1, NULL, NULL),
       ('Tech Summit', 'Technology', 400, '2024-09-15 10:00:00', 15, 1, 1, NULL),
       ('Ballet Performance', 'Dance', 700, '2024-10-05 18:00:00', 60, 1, NULL, NULL),
       ('Film Festival', 'Film', 200, '2024-11-12 12:00:00', 20, 1, NULL, NULL),
...
INSERT INTO `ticket_shop`.`ticket` (`date`, `price`, `status`, `type`, `manifestation_id`, `user_id_buyer`)
VALUES ('2024-06-10 15:30:00', 50, 1, 'Regular', NULL, NULL),
       ('2024-07-18 17:00:00', 30, 1, 'Regular', NULL, NULL),
       ('2024-08-05 10:30:00', 60, 1, 'Regular', NULL, NULL),
       ('2024-09-03 08:45:00', 20, 1, 'Regular', NULL, NULL),
       ('2024-06-20 14:45:00', 70, 1, 'Regular', NULL, NULL),
       ('2024-07-25 20:15:00', 25, 1, 'Regular', NULL, NULL),
       ('2024-08-15 11:30:00', 45, 1, 'Regular', NULL, NULL),
       ('2024-09-20 10:45:00', 15, 1, 'Regular', NULL, NULL),
       ('2024-10-10 19:15:00', 60, 1, 'Regular', NULL, NULL),
       ('2024-11-20 13:45:00', 20, 1, 'Regular', NULL, NULL),
       ('2024-12-15 22:30:00', 30, 1, 'Regular', NULL, NULL),
